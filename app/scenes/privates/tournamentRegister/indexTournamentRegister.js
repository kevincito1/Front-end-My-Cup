import { tournamentRegisterventanaemergente, tournament, title, form1, form2, form3, form4, form5, form6, form7, btn, button, btnsection, containerbtn, Addbtn, listaArticulos, container, childdiv, card,BtnAddteam } from './styleTournamentRegister.css'
...
<form id ="tournamentform"class="${tournament}">
    ...
    <button class="${btn}">
        <div id="btnsubtmitregister" class="${button}">
...
<section id="ventanaEmergente1" class="${tournamentRegisterventanaemergente}">
            <div class="contenido">
             <div id="container" class="${container}">
                 <button class="${BtnAddteam}" id="addDivBtn">Agregar Team</button>
             </div>

              <button id="cerrarBtn1">Cerrar</button>
            </div>
</section>
`;